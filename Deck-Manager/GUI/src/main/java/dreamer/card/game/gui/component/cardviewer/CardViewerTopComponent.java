        ...
        implements LookupListener
{
  private static final Logger LOG
          = Logger.getLogger(CardViewerTopComponent.class.getName());
  private final Lookup.Result<ICard> result
          = Utilities.actionsGlobalContext().lookupResult(ICard.class);
        ...
        if (item instanceof ICard)
        {
          ...
          try
          {
            ...
            else
            {
              ...
              if (cache != null)
              {
                URL imageURL = cache.createRemoteImageURL(card,
                        Editions.getInstance().getEditionByName(cs.getName()));
                ImageIcon icon = null;
                if (imageURL != null)
                {
                  icon = Tool.loadImage(this, ImageIO.read(
                          cache.getCardImage(card,
                                  cs, imageURL, true, false)));
                }
                if (icon == null)
                {
                  //Image not there
