...
public class MTGCardCache extends AbstractCardCache
{
          ...
          implements ActionListener
  {
        ...
        try
        {
          ...
          if (card != null)
          {
            ...
            synchronized (this)
            {
              ...
              card = new CardJpaController(((DataBaseCardStorage) Lookup.getDefault()
                      .lookup(IDataBaseCardStorage.class))
                      .getEntityManagerFactory()).findCard(card.getCardPK());
    ...
    private final ArrayList<String> mana = new ArrayList<>();
  ...
  {
    LOG.log(Level.FINE, "Getting set icon for: {0}", set.getName());
